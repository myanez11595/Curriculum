...
server<-function(input, output){
  ...
  output$mapa <- renderLeaflet({
    ...
    leaflet() %>% addProviderTiles(providers$Esri.WorldImagery,group = "Satelite")%>%addProviderTiles(providers$OpenTopoMap, group = "Topo") %>% addProviderTiles(providers$OpenStreetMap.HOT, group = "HOT") %>% 
      ...
      addLayersControl( overlayGroups = c("Satelite","Topo","HOT","Agua cruda","Agua de río","Agua potable", "Agua residual","Lixiviados","Suelo","Leyenda"), options=layersControlOptions(collapsed = F,labels="Layers",title = "Layers",color="blue"))%>%
